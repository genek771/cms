    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_title', models.CharField(max_length=150, verbose_name='Под заголовок')),
                ('mini_text', models.TextField(max_length=500, verbose_name='Превью статьи')),
                ('text', models.TextField(verbose_name='Превью статьи')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderated', models.BooleanField(default=False, verbose_name='Статус одбрено')),
